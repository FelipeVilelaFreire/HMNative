...
import { ReviewCard, AddReviewCard } from './components';
import { styles, CARD_WIDTH } from './ActivityReviewsCard.styles';
...
interface ActivityReviewsCardProps {
  reviews: Review[];
}

export default function ActivityReviewsCard({ reviews }: ActivityReviewsCardProps) {
