...
import { styles } from './ActivityInitialData.styles';

interface ActivityInitialDataProps {
  distance: string;
  rating: number;
  reviewsCount: number;
}

export default function ActivityInitialData({ distance, rating, reviewsCount }: ActivityInitialDataProps) {
