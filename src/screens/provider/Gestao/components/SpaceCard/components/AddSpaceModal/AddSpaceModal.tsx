...
import { styles } from './AddSpaceModal.styles';

interface AddSpaceModalProps {
  visible: boolean;
  onClose: () => void;
  onSave: (space: NewSpace) => void;
}
...
export default function AddSpaceModal({ visible, onClose, onSave }: AddSpaceModalProps) {
